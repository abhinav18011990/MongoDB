...
//              Updating Documents        db.collection.update(query, update, options)**
...
3. db.movies.find({$text:{$search:'Bilbo -Gandalf'}})                 [//NOT](//not) → -
4. db.movies.find({$text:{$search:'dwarves hobbit'}})               //OR
5. db.movies.find({$text:{$search:"'gold' 'dragon'"}})               //AND
